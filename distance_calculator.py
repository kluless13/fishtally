# Modified from Ultralytics source code AGPL-3.0 license.
...
class DistanceCalculation:
    ...
    def display_frames(self):
        """Display frame."""
        cv2.namedWindow("Fishtally Distance Estimation")
        cv2.setMouseCallback("Fistally Distance Estimation", self.mouse_event_for_distance)
        cv2.imshow("Fishtally Distance Estimation", self.im0)
